...
class Conway(PlanetTk):
    ...
    def __init__(self, root, name, latitude_cells_count, longitude_cells_count, background_color='white',
                 foreground_color='dark blue', gridlines_color='maroon',
                 cell_size=20, gutter_size=0, margin_size=0, show_content=True, show_grid_lines=True, **kwargs):
        super().__init__(root, name, latitude_cells_count, longitude_cells_count, {Human}, Ground(), background_color=background_color, foreground_color=foreground_color,
...
if __name__ == '__main__':
    ...
    GUTTER_SIZE = 0
    MARGIN_SIZE = 10
    app = Conway(root, "Terre",  LINES_COUNT, COLUMNS_COUNT,
